...
public class GNodeDataWriter {
     ...
     */
    public boolean write(String location, NeuronLayer layer, GNodeHitValueData gnhvd, int cycleId) {
        ...
        try {
            ...
            StreamResult result = new StreamResult(new File(location + File.separator+"LC " + String.valueOf(cycleId) + ".xml"));// file name is created with neuron id
