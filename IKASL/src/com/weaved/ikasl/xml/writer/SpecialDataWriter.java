 ...
 */
package com.weaved.ikasl.xml.writer;
...
public class SpecialDataWriter {
     ...
     */
    public boolean write(String folderLoc, ArrayList<String> list, int cycleId) {
        ...
        try {
            ...
            StreamResult result = new StreamResult(new File(folderLoc + File.separator + "SpecialData.xml"));// file name is created with neuron id
     ...
     * @return
     */
    public boolean append(String location, ArrayList<String> list, int cycleId) {//write(ArrayList<String> list, int cycleId)


        String fileName = location + File.separator + "SpecialData.xml";
        ...
        try {
            ...
            this.write(location, list, cycleId);
        } catch (Exception e) {
